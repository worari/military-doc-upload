...
app = Flask(__name__)
app.secret_key = os.getenv("e3a91e6c77cb4bc8a4f1f5a13279924cddc5c94d65d9be9e6e738fbd22a1aab4")
app.config['UPLOAD_FOLDER'] = 'uploads'

# เชื่อมต่อ PostgreSQL
conn = psycopg2.connect(os.getenv("postgresql://postgres:lNSmektsHjEYXfAZveNvADUzFcuvoCXw@maglev.proxy.rlwy.net:57008/railway"))
cursor = conn.cursor()
